"""Data Lineage Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Data lineage tracking agent that maps data flow from source to consumption, traces column-level lineage, detects impact of schema changes, and visualizes data dependency graphs for root cause analysis.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
